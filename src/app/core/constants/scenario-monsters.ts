export const SCENARIO_MONSTERS = [
  ...
  // TODO Show message that this is random,
  // use deck tab instead
  {
  ...
  },
  {
    ...
    decks: [{ name: 'Ooze' }, { name: 'Forest Imp' }, { name: 'Rending Drake' }]
  },
  {
    name: '#65 Sulfur Mine',
    decks: [
  ...
  },
  {
    ...
    decks: [{ name: 'Vermling Scout' }, { name: 'Giant Viper' }]
  },
  {
  ...
  },
  {
    ...
    decks: [{ name: 'Wind Demon' }, { name: 'Lurker' }, { name: 'Frost Demon' }]
  },
  {
  ...
  {
    name: '#K10 Panic Room',
    decks: [{ name: 'Night Demon' }, { name: 'Deep Terror' }]
  },
  // solo scenarios
  {
  ...
  },
  {
    ...
    decks: [{ name: 'Cave Bear' }, { name: 'Ooze' }, { name: 'Sun Demon' }]
  },
  {
  ...
  },
  {
    ...
    decks: [{ name: 'Giant Viper' }, { name: 'Black Imp' }]
  },
  {
